...
\section{Summary}
{\justifying
I am a PhD candidate at the University of Texas at Austin actively seeking full-time position in operating system, compiler and computer architecture.
My research interests are {\bf software/hardware co-design and system-level performance modeling} with an emphasis in embedded/mobile domains.

%More specifically, my research expertise also includes
%efficient deployment of computer vision and deep learning algorithms on top of distributed systems.
\vspace{-5pt}
\par}
%-----------SKILLS-----------------
\section{Skills}
  \resumeSubHeadingListStart
      \resumeItemList{{\bf Programming languages}: C/C\plusplus, Python, Java and Verilog.}
      \resumeItemList{{\bf Tools and frameworks}: LLVM, Caffe2, SystemC, Darknet, OMNeT++, lwIP.}
      \resumeItemList{Project experiences with {\bf operating system kernel programming}, {\bf multi-threaded programming} (POSIX pthreads) and {\bf network programming} (Socket Programming in C).}
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingList
      {B.S. in Electrical Engineering;}{Aug. 2008 -- June. 2012}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {University of Texas at Austin}{Austin, Texas}
      {Graduate Research Assistant}{Jan 2013 - Present}
      \resumeItemListStart
...
\vspace{-5pt}
  \resumeSubHeadingListStart
    \resumeSubheadingList
      {University of California, Los Angeles}{Austin, Texas}
...
\section{Relevant Graduate Coursework}
  \resumeSubHeadingListStart
	...
	\resumeItemList{EE382M System-on-a-Chip Design}
        \resumeItemList{EE382M VLSI-I}
        \resumeItemList{EE382M VLSI-II}
