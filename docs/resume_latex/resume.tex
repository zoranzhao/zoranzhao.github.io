...
\section{Summary}
{\justifying
I am a PhD candidate at the University of Texas at Austin actively seeking a full-time position in operating system, compiler and computer architecture.
...
More specifically, my research expertise also includes efficient deployment of computer vision and deep learning algorithms on top of distributed embedded/mobile systems.
\vspace{-5pt}
\par}
%-----------SKILLS-----------------
\section{Skills}
  \resumeSubHeadingListStart
      ...
      \resumeItemList{{\bf Tools and frameworks}: LLVM, Caffe2, Darknet, OMNeT++, lwIP.}
