...
\section{Summary}
{\justifying
I am a PhD student at the University of Texas at Austin actively seeking full-time position in related areas such as {\bf operating system, compiler, computer architecture and mobile/edge computing}. More specifically, my research expertise is {\bf efficient deployment of computer vision and deep learning algorithms} on top of {\bf distributed embedded/mobile systems}.
\vspace{-5pt}
\par}
%-----------SKILLS-----------------
\section{Skills}
